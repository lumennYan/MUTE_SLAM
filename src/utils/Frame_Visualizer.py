...
class Frame_Visualizer(object):
    ...
    def save_imgs(self, idx, iter, gt_depth, gt_color, c2w_or_camera_tensor, submap_list, decoders):
        """
        ...
        with torch.no_grad():
            if (idx % self.freq == 0) and (iter % self.inside_freq == 0):
                ...
                depth, color = self.renderer.render_img(submap_list, decoders, c2w, self.truncation,
